...
Exists on top of an L1 blockchain. Starknet is an L2 blockchain for Ethereum, enabling any dApp to achieve massive computation scale without compromising on Ethereum’s composability and security.
